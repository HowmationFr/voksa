...
export const enMenus: Record<string, string> = {
  ...
  'Sortie système (par défaut)': 'System output (default)',
  'Recherche des périphériques…': 'Looking for devices…',
  'Aucune autre sortie détectée': 'No other output detected',
  'Rouvrir l’onglet fermé': 'Reopen closed tab',
  'Épingler l’onglet': 'Pin tab',
  'Désépingler l’onglet': 'Unpin tab',
